...
- Generator: `server/scripts/generate-doc-index.mjs`; a composite SHA-256 covering the generator, parser, archive policy, integrity implementation, schema/config, locked dependencies, and compiler configuration is embedded in the generated manifest.
